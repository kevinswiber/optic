...
declare module 'postman-collection' {
  ...
  export class ItemGroup extends Property {
     ...
     */
    forEachItem(callback: (...params: any[]) => any): void;
    /**
     * Check whether an object is an instance of ItemGroup.
     * @param obj - -
     */
  ...
  export class PropertyList {
     ...
     */
    remove(
      predicate: ((...params: any[]) => any) | string | PropertyList.Type,
      context: any
    ): void;
    /**
     ...
     */
    map(iterator: (...params: any[]) => any, context?: any): any[];
    /**
  ...
  export class Property extends PropertyBase {
    ...
    static replaceSubstitutions(
      str: string,
      variables: VariableList | any | (VariableList | object)[]
    ): string;
    /**
     ...
     * @param variables - -
     */
    static replaceSubstitutionsIn(
      obj: any,
      variables: (VariableList | object)[]
    ): any;
    /**
  ...
  export class QueryParam extends Property {
     ...
     * @param [param.value] - -
     */
    update(param: { key: string; value?: string }): void;
    /**
  ...
  export class VariableScope extends Property {
    constructor(definition: VariableList | any[], layers?: VariableList[]);
    /**
